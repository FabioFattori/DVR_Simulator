...
nodes = ["Dispositivo di origine","Home Router","ISP","BackBone Node","IXP","Google Global Network","Destination Server"]
...
net.addConnection("Google Global Network","Google Destination Server",1)
